    ...
    <div className="sticky top-0 z-50 backdrop-blur-md bg-linear-to-r from-black via-[#021118] to-black border-b border-white/10 pl-2 pr-8 flex items-center justify-between h-30">
      ...
      <div className="flex items-center gap-6">
        <Link className="relative text-md font-lato transition-all duration-300 
             text-white/80 hover:text-cyan-300" href="/">
          Home
        </Link>
        <Link className="relative text-md font-lato transition-all duration-300 
              text-white/80 hover:text-cyan-300" href="/user-profile">
          User Profile
        </Link>
        <Link className="relative text-md font-lato transition-all duration-300 
              text-white/80 hover:text-cyan-300" href="/transactions">
          Transactions
        </Link>
        <Link className="relative text-md font-lato transition-all duration-300 
              text-white/80 hover:text-cyan-300" href="/dashboard">
          Dashboard
        </Link>
      </div>
